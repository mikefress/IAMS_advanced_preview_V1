...
let startTime;
var tl;
const frame1_duration = '';
const frame2_duration = '';
const ctaDelay = '';
const frame2_start_time = '';
const frame3_start_time = '';
const text1AnimationDuration = '';
const text2AnimationDuration = '';
const iconAnimationDuration = '';
const dogAnimationDuration = '';
const logoAnimationDuration = '';
const dogDelay = 0;
const logoDelay = 0;
function init() {
    startTime = new Date();
